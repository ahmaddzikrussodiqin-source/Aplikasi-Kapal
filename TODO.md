# TODO - Fix Persiapan Edit Issue & Add Status Kerja Kapal
...
- [x] Add statusKerja field to KapalStatusEntity
- [x] Create logic to populate KapalStatus data from KapalMasuk data in ProfileActivity
...
Added statusKerja field to KapalStatusEntity and implemented sync logic in ProfileActivity to populate KapalStatus data from existing KapalMasuk data from the online database.
...
- [ ] Verify KapalStatus data is populated correctly from KapalMasuk data
