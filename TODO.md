...
- backend/server.js (added logging for tanggalKadaluarsa changes, fixed column name quoting in UPDATE query, added migration for existing lowercase column names)
